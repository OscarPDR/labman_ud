...
var Dajaxice = {
    ...
    get_funding_call: function(callback_function, argv, custom_settings){
        return Dajaxice.call('project_manager.get_funding_call', 'POST', callback_function, argv, custom_settings);
    }
