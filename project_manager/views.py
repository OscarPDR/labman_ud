...
from funding_call_manager.models import *
from funding_call_manager.forms import *
...
def info_project(request, slug):
    ...
    if project.funding_program.full_name:
        funding_program = project.funding_program
    else:
        funding_program = project.funding_program.funding_call
