...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('utils', '0002_auto_20150115_0953'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='role',
            options={'ordering': ['relevance_order']},
        ),
        migrations.AlterField(
            model_name='award',
            name='log_created',
            field=models.DateTimeField(default=datetime.datetime(2015, 1, 15, 10, 1, 3, 16796), auto_now_add=True),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='award',
            name='log_modified',
            field=models.DateTimeField(default=datetime.datetime(2015, 1, 15, 10, 1, 3, 16847), auto_now=True),
            preserve_default=True,
        ),
        migrations.AlterField(
