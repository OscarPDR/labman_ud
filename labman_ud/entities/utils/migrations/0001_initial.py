    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('faculty', models.ForeignKey(related_name=b'faculty_holding_a_phd_program', blank=True, to='organizations.Organization')),
                ('university', models.ForeignKey(related_name=b'university_holding_a_phd_program', to='organizations.Organization')),
            ],
            options={
                'abstract': False,
            },
